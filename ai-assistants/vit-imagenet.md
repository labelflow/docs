...
Vision Transformer (ViT) model was pre-trained by Google on ImageNet-21k (14 million images, 21,843 classes), and fine-tuned on ImageNet 2012 (1 million images, 1,000 classes). The model is hosted by Hugging Face and you can find its complete description card [here](https://huggingface.co/google/vit-base-patch16-224).
